    ...
    def _fetch_yfinance_data(symbol: str) -> Optional[dict]:
        ...
        try:
            ...
            return {
                ...
                "changePercent":    round(price_change_pct, 4),
                "prevClose":        previous_close,
                "open":             open_price,
                "dayHigh":          day_high,
                "dayLow":           day_low,
                "fiftyTwoWeekHigh": year_high or info.get('fiftyTwoWeekHigh'),
                "fiftyTwoWeekLow":  year_low  or info.get('fiftyTwoWeekLow'),
                "volume":           APIClient.format_large_number(volume),
                "avgVolume":        APIClient.format_large_number(avg_volume),
                "marketCap":        APIClient.format_large_number(market_cap),
